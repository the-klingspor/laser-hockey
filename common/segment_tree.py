...
without changes and used for the PrioritizedReplayBuffer class. This is the only piece
of code in our repository that was copied from an external source.
"""
